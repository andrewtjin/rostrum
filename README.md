...
Caveat — **"Show hidden text" display setting:** if a reader has *File ▸ Options ▸ Display
...
frozen — you can't scroll, type, or switch documents until it finishes. Rostrum's
